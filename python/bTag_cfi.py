...
ak5JPTSoftElectronTagInfos = softElectronTagInfos.clone( leptonCands = cms.InputTag("softElectronCands"), jets = 'ak5JPTJets' )
ak5JPTSoftMuonTagInfos = softMuonTagInfos.clone(jets = 'ak5JPTJets' )
