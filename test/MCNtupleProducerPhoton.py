...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(4000) )  # number of events 
...
process.calibTreeMakerAK7PF.ECALDeadCellBEFilterModuleName = cms.InputTag("EcalDeadCellBoundaryEnergyFilter")
process.calibTreeMakerAK7PF.ECALDeadCellTPFilterModuleName = cms.InputTag("EcalDeadCellTriggerPrimitiveFilter")
